...
#elif defined(Wiper_Motor_START_SEC_CODE)
#undef Wiper_Motor_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(Wiper_Motor_STOP_SEC_CODE)
#undef Wiper_Motor_STOP_SEC_CODE
