...
#elif defined(Rain_Sensor_START_SEC_CODE)
#undef Rain_Sensor_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(Rain_Sensor_STOP_SEC_CODE)
#undef Rain_Sensor_STOP_SEC_CODE
